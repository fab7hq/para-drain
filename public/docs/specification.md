...
![Centered ParaDrain upstream markings on both handles](../media/handle-marking.png)
...
![Front and side dimensional drawing](../media/dimensions.svg)
...
The authoritative geometry and canonical two-cycle animation are [the shared JSON dataset](../model/paradrain.json). The final Blender file is rebuilt from it, and the Three.js viewer reads it directly. [Validation notes](validation.md) identify deterministic checks and their limitations.
